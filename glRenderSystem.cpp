...
namespace violet {
	...
	void glRenderSystem::bindTexture(const TexPtr&tex) {
		GLuint sampler;
		switch (tex->_type) {
			...
			case Texture::TEX_TYPE::TextureType_NORMALS: {
				...
				sampler = glGetUniformLocation(_curGpuProgram, "normalTex");
				glUniform1i(sampler, 1);
				break;
			}
			case Texture::TEX_TYPE::TextureType_LIGHTMAP: {
				glActiveTexture(GL_TEXTURE2);
				sampler = glGetUniformLocation(_curGpuProgram, "lightTex");
